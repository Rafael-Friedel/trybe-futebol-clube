const queryBestInAway = `SELECT t.team_name as name,
  ...
  cast(SUM(m.away_team_goals) as unsigned integer)  AS goalsFavor,
  cast(SUM(m.home_team_goals) as unsigned integer) AS goalsOwn,
...
export default queryBestInAway;
